...
void AiecEA_stealer_edge(uint32_t N, uint32_t M, uint32_t fused_layers, char* network, char* weights, uint32_t edge_id){
   device_ctxt* ctxt = AiecEA_edge_init(N, M, fused_layers, network, weights, edge_id);
...
void AiecEA_victim_edge(uint32_t N, uint32_t M, uint32_t fused_layers, char* network, char* weights, uint32_t edge_id){
   ...
   sys_thread_t t2 = sys_thread_new("send_result_thread", send_result_thread, ctxt, 0, 0);
   sys_thread_t t3 = sys_thread_new("AiecEA_serve_stealing_thread", AiecEA_serve_stealing_thread, ctxt, 0, 0);
