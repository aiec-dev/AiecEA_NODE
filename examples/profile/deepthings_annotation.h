#ifndef AiecEA_ANNOTATION_H
#define AiecEA_ANNOTATION_H
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <stdint.h>
...
/*Include necessary context objects from AiecEA and darkiot*/
